...
int main(int argc, char **argv)
{
    ...
    if(argc != 3)
    {
        cerr << endl << "Usage: rosrun ORB_SLAM2 RGBDAR path_to_vocabulary path_to_settings" << endl;        
        ros::shutdown();
        return 1;
    }
    ...
    // ros::Subscriber sub = nodeHandler.subscribe("/camera/image_raw", 1, &ImageGrabber::GrabRGBD,&igb);
